...
{   
    public static void InitDb(WebApplication app) { // will use this in Starup.cs
    ...
    {
        context.Database.Migrate(); // apply any pending migration to the context db

        if (context.Auctions.Any()) {
            Console.WriteLine("DB already exist - no need to seed");
        }
